...
export const createTaskSchema = z.object({
  ...
  status: z.enum(['inbox', 'assigned', 'awaiting_owner', 'in_progress', 'review', 'quality_review', 'done']).default('inbox'),
...
export const bulkUpdateTaskStatusSchema = z.object({
  tasks: z.array(z.object({
    ...
    status: z.enum(['inbox', 'assigned', 'awaiting_owner', 'in_progress', 'review', 'quality_review', 'done']),
